...
const NavBar = ({}: NavBarProps) => {
  ...
  return (
    <>
      <div
        className="fixed top-0 left-0 -z-10 w-screen bg-white"
        style={{ height: 82 }}
      ></div>
      <nav className="w-100 fixed top-0 left-0 z-50 w-screen overflow-hidden border-b border-b-gray-200 py-5">
        <div className="absolute top-0 left-0 -z-10 h-full w-full bg-white/20 backdrop-blur-md"></div>
        <Container>
